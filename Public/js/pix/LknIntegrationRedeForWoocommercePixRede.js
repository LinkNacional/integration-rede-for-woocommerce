const settingsRedePix = window.wc.wcSettings.getSetting('integration_rede_pix_data', {})
const labelRedePix = window.wp.htmlEntities.decodeEntities(settingsRedePix.title)
const ContentRedePix = props => {
  return /* #__PURE__ */React.createElement('div', {
    class: 'LknIntegrationRedeForWoocommercePaymentFields'
  }, /* #__PURE__ */React.createElement('p', null, settingsRedePix.description), /* #__PURE__ */React.createElement('svg', {
    id: 'logo-rede',
...
const BlockGatewayRedePix = {
  name: 'integration_rede_pix',
  label: labelRedePix,
  content: window.wp.element.createElement(ContentRedePix),
  edit: window.wp.element.createElement(ContentRedePix),
  canMakePayment: () => true,
  ariaLabel: labelRedePix,
  supports: {
    features: settingsRedePix.supports
  }
}
window.wc.wcBlocksRegistry.registerPaymentMethod(BlockGatewayRedePix)
