...
const ContentIntegrationRedePix = (props) => {
  return (
    <div style={{
      ...
      <div className="LknIntegrationRedeForWoocommercePaymentFields">
        <p>Pay for your purchase with a pix through</p>
        <svg id="integration-logo-rede" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 480.72 156.96">
          <title>logo-rede</title>
          <path
            className="cls-1"
            style={{ fill: 'rgb(255, 120, 0)' }}
      ...
      >
        <div className="wc-block-components-button__text" style={{display: 'flex', alignItems: 'center', gap: '10px'}}>
...
const BlockGatewayIntegrationRedePix = {
  ...
  content: <ContentIntegrationRedePix />,
  edit: <ContentIntegrationRedePix />,
  canMakePayment: () => true,
