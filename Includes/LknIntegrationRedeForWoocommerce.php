...
final class LknIntegrationRedeForWoocommerce {
    ...
    private function define_admin_hooks(): void {
        ...
        $this->loader->add_action('woocommerce_scheduled_subscription_payment_' . $this->wc_rede_credit_class->id, $this->wc_rede_credit_class, 'process_subscription_payment', 10, 2);
