...
use Lkn\IntegrationRedeForWoocommerce\Public\LknIntegrationRedeForWoocommercePublic;
...
class LknIntegrationRedeForWoocommerce
{
	...
	private function load_dependencies()
	{
		 ...
		 * core plugin.
		 */
		require_once plugin_dir_path(dirname(__FILE__)) . 'includes/LknIntegrationRedeForWoocommerceLoader.php';

		/**
		 * The class responsible for defining all actions that occur in the admin area.
		 */
		require_once plugin_dir_path(dirname(__FILE__)) . 'admin/class-LknIntegrationRedeForWoocommerceAdmin.php';

		/**
		 * The class responsible for defining all actions that occur in the public-facing
		 * side of the site.
		 */
		require_once plugin_dir_path(dirname(__FILE__)) . 'public/LknIntegrationRedeForWoocommercePublic.php';
