    ...
    class Lkn_Puc_Scheduler {
        ...
        public function upgraderProcessComplete(
            ...
            if (
                ...
                || 'update' !== $upgradeInfo['action'] || ! in_array($upgradeInfo['type'], array('plugin', 'theme'), true)
            ) {
                return;
            }
        ...
        protected function getEffectiveCheckPeriod() {
            ...
            if ( in_array($currentFilter, array('load-update-core.php', 'upgrader_process_complete'), true) ) {
                //Check more often when the user visits "Dashboard -> Updates" or does a bulk update.
                $period = 60;
            } else {
                if ( in_array($currentFilter, $this->hourlyCheckHooks, true) ) {
