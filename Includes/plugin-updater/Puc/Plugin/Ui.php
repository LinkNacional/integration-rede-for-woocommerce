<?php
if ( ! class_exists('Lkn_Puc_Plugin_Ui', false) ) {
    /**
     * Additional UI elements for plugins.
     */
    class Lkn_Puc_Plugin_Ui {
        private $updateChecker;
        private $manualCheckErrorTransient = '';

        /**
         * @param Lkn_Puc_Plugin_UpdateChecker $updateChecker
         */
        ...
        public function handleManualCheck(): void {
            ...
            if ( $shouldCheck ) {
                ...
                if ( (null === $update) && ! empty($lastRequestApiErrors) ) {
                    ...
                    foreach ($lastRequestApiErrors as $item) {
                        ...
                        if ( ! in_array($wpError->get_error_code(), $questionableErrorCodes, true) ) {
         ...
         */
        public function displayManualCheckResult(): void {
