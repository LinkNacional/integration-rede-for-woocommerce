...
if ( ! class_exists('Lkn_Puc_Plugin_UpdateChecker', false) ) {
    ...
    class Lkn_Puc_Plugin_UpdateChecker extends Lkn_Puc_UpdateChecker {
        ...
        protected function createScheduler($checkPeriod) {
            $scheduler = new Lkn_Puc_Scheduler($this, $checkPeriod, array('load-plugins.php'));
        ...
        public function injectInfo($result, $action = null, $args = null) {
            $relevant = ('plugin_information' == $action) && isset($args->slug) && (
                ($args->slug == $this->slug) || (dirname($this->pluginFile) == $args->slug)
            );
            if ( ! $relevant ) {
                return $result;
            }
         ...
         * @return void
         */
        public function addQueryArgFilter($callback): void {
         ...
         * @return void
         */
        public function addHttpRequestArgFilter($callback): void {
         ...
         * @return void
         */
        public function addResultFilter($callback): void {
