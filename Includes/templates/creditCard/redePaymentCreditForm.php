...
<fieldset id="rede-credit-payment-form" class="rede-payment-form">
	...
	<div class="rede-credit-fields-wrapper">
		...
		<div class="wc-payment-rede-form-fields">
			...
			<div class="form-row form-row">
				<label id="labels-with-icons" for="rede-card-expiry">
			...
			<div class="form-row form-row">
				<label id="labels-with-icons" for="rede-card-cvc"><?php esc_attr_e('Security Code', 'integration-rede-for-woocommerce' ); ?><span class="required">*</span>
					<div class="icon-rede-input">
