	...
	<div class="maxipagoDebitFieldsWrapper">
		...
		<?php if (!is_plugin_active('woocommerce-extra-checkout-fields-for-brazil/woocommerce-extra-checkout-fields-for-brazil.php')) {	?>
			...
			<div class="form-row form-row">
				<label id="labels-with-icons" for="maxipago_debit_card_cpf">
		...
		<div class="form-row form-row">
			<label id="labels-with-icons" for="maxipago_debit_card_holder_name">
			...
			<input id="maxipago_debit_card_holder_name"
				name="maxipago_debit_holder_name" class="input-text"
				type="text"
		...
		<div class="form-row form-row">
			<label id="labels-with-icons" for="maxipago_debit_card_expiry">
			...
			<input id="maxipago_debit_card_expiry"
		...
		<div class="form-row form-row">
			<label id="labels-with-icons" for="maxipago_debit_card_cvc"><?php esc_attr_e('Security Code', 'integration-maxipago-for-woocommerce' ); ?><span class="required">*</span>
				<div class="icon-maxipago-input">
			...
			<input id="maxipago_debit_card_cvc"
