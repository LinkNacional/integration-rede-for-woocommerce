...
?>
<fieldset
	id="rede-debit-payment-form"
	class="rede-payment-form"
>
	<div class="payment-method-description">
		<p><?php esc_html_e( 'Pay for your purchase with a debit card through ', 'integration-rede-for-woocommerce' ); ?>
		</p>
		<svg
			id="logo-rede"
		...
		<div class="wc-payment-rede-form-fields">
			<div id="doble-input-div">
				...
				<div class="form-row form-row-wide rede-card">
					<label
						id="labels-with-icons"
						for="rede-debit-card-holder-name"
					>
					...
					<input
						id="rede-debit-card-holder-name"
