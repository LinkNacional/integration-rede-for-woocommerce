...
<div class="lkn-rede-google-pay-payment-fields">
    <?php if ( ! empty( $description ) ) : ?>
        <div class="lkn-rede-google-pay-description-container">
            <p class="lkn-rede-google-pay-description"><?php echo wp_kses_post( $description ); ?></p>
            <svg
                id="logo-rede"
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 480.72 156.96"
                style="left: initial !important; position: static !important; top: initial !important; transform: none !important; vertical-align: initial !important; height: 20px !important;"
            >
                <defs>
                    <style>
                        .cls-1 {
